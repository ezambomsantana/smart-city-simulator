...
run() ->
	...
	InitFile = file_utils:open( "teste", _Opts=[ append, delayed_write ] ),
	...
	S1 = class_Actor:create_initial_actor( class_Station,
		[ _StationName="Rodoviaria", _StationLat=100,
		 _StationLong=1.0 ] ),

	_C1 = class_Actor:create_initial_actor( class_Car,
		[ _CarName="Car 1", _CarLat=100,
		 _CarLong=1.0, _CarSpeed=20, _InitialStation=S1 ] ),
